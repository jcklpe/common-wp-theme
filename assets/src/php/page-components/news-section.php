...
>
	<div class="dsa-home-row-4-edit text-center grid-container">
		<div class="grid-x grid-margin-x grid-margin-y text-center txt-white ">
			<img
				src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icons/white/typewriter.svg"
				loading="lazy"
		...
		<div class="row text-center padding-bottom">
			...
			this is the way to show it by category tho for future reference
			 href="<?php echo esc_url( $category_link ); ?>"  -->
			<a
				href="<?php echo site_url(); ?>/?post_type=post"
				class="button"
				title="Dispatches"
			>See All</a>
		</div>
