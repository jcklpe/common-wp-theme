<div
	...
	<div class="grid-container homepage-events">
		<div class="grid-x grid-margin-x grid-margin-y text-center">
			<img
				src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icons/white/calendar.svg"
				loading="lazy"
				class="cell large-2 large-offset-5 medium-4 medium-offset-4 small-6 small-offset-3"
			/>
			<br />
				...
				<div class="card cell small-12">
					...
					<div class="grid-x grid-margin-x">
						<div class="cell large-7 medium-6 small-12">
							...
							<a
								href="<?php echo tribe_get_event_link ( $event->ID  ); ?>"
								class="button"
							>Find out more &rsaquo;</a>
						</div>
						<div class="cell large-5 medium-6 small-12">
							...
							<div class="grid-x grid-margin-x">
								<div class="cell large-3 medium-4 small-3">
									<a href="<?php echo tribe_get_event_link ( $event->ID  ); ?>">
										<img
											src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icons/white/location.svg"
											class="dsa-calendar-icon"
											loading="lazy"
										/>
									</a>
